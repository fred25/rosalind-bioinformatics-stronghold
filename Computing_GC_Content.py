...
information. Subsequent lines contain the string itself; the first line to begin with
...
the GC-content of that string. Rosalind allows for a default error of 0.001 
...
for DNA in DNA_strings:
    DNA_GC_percents[DNA] = (DNA_strings[DNA].count("G")+DNA_strings[DNA].count("C"))/len(DNA_strings[DNA])*100

highest_GC_DNA = max(DNA_GC_percents, key=DNA_GC_percents.get)
print(highest_GC_DNA)
print(DNA_GC_percents[highest_GC_DNA])